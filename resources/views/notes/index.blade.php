<x-app-layout :title=$title>
    ...
    @if (session()->has('success'))
        <div x-data="{ isOpen: true }" x-show="isOpen" x-cloak
            class="relative flex flex-col sm:flex-row items-center justify-center bg-gray-300 dark:bg-green-700 shadow rounded-md py-5 px-6 sm:px-8 mb-3 mt-3 ">
            <div class="flex items-center">
                <div class="text-green-300 dark:text-green-500  ">
                ...
                <div class="text-sm tracking-wide text-gray-800 dark:text-white ml-4">
                    {{ session('success') }}
                </div>
                <div @click="isOpen = false"
                    class="absolute top-4 right-4 text-gray-400 hover:text-gray-800 cursor-pointer">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor"
                        class="w-6 h-6">
